...
implementation
//----------------------------------------------------------------------------
uses Math, main_f, tirage_f, fdmatch_f;
//----------------------------------------------------------------------------
{$R *.lfm}
//----------------------------------------------------------------------------
const
...
// v1.8.5 : On prend comme modèle la feuille de match
(*
Top:=FormTirage.Top+FormTirage.Height+DeltaHeight; // vLaz : constante DeltaHeight définie dans main_f
Left:=FormMain.Left+FormMain.Width;
Height:=FormMain.Height-FormTirage.Height-DeltaHeight; // v1.8.3 (même définition que la feuille de match)
*)
